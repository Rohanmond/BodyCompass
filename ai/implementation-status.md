...
- Phase 4W W2: strength workout basics compile (HealthKit lifecycle, heart rate/energy, load/reps/RIR, rest countdown, and haptics); elapsed time, substitutions, pain notes, haptic preferences, completion polish, and paired-device verification remain.
