...
- Node backend with real meal provider adapters and mock fallback when keys are absent; chat remains mocked.
...
- Real OpenAI and Gemini chat/progress-photo calls.
